...
namespace EmployeesCh12.Controllers
{
    public class DepartmentLocationsController : Controller
    {
        ...
        {
            var employeeContext = _context.DepartmentLocations.Include(d => d.Department);
        ...
        {
            ViewData["LocationID"] = new SelectList(_context.Departments, "ID", "ID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("DepartmentID,LocationID")] DepartmentLocation departmentLocation)
        {
            ...
            ViewData["LocationID"] = new SelectList(_context.Departments, "ID", "ID", departmentLocation.LocationID);
            return View(departmentLocation);
        }
