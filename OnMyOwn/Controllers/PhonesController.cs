...
namespace OnMyOwn.Controllers
{
    public class PhonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PhoneId,PhoneName,PhoneType")] Phone phone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PhoneId,PhoneName,PhoneType")] Phone phone)
        {
            if (id != phone.PhoneId)
            {
                return NotFound();
