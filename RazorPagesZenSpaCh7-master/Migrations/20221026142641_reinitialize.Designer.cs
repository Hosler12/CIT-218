...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221026142641_reinitialize")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 26, 7, 26, 40, 646, DateTimeKind.Local).AddTicks(7390),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 10, 26, 7, 26, 40, 649, DateTimeKind.Local).AddTicks(6263),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 10, 26, 7, 26, 40, 649, DateTimeKind.Local).AddTicks(6324),
                            ServicesID = 5
                        });
                });
